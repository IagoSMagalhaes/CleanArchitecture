package com.example.clean.architecture.usecases.service.user.impl
...
@Service
open class UserUsecaseImpl(val repository: UserRepository) : UserUsecase {

	 val LOG = LoggerFactory.getLogger(UserUsecaseImpl::class.java)
